...
Function_0x801dd818: # 0x801dd818
    ...
    swc1    $f4, 0x9c($a0)
    lwc1    $f6, 0x5d48($at)
    lui     $t6, %hi(Unknown_0x801921b8_GeneralWaterLevel)
    lui     $at, 0x8022
    swc1    $f6, 0xa0($a0)
    lw      $t6, %lo(Unknown_0x801921b8_GeneralWaterLevel)($t6)
    or      $s0, $a1, $zero
    or      $a3, $a0, $zero
    mtc1    $t6, $t0
    nop
...
.globl Function_0x801ddba8_CameraMovement
Function_0x801ddba8_CameraMovement: # 0x801ddba8
    addiu   $sp, $sp, 0xffd0
    sw      $s4, 0x28($sp)
    lui     $s4, %hi(Unknown_0x800da8a8)
    addiu   $s4, $s4, %lo(Unknown_0x800da8a8)
    lw      $t6, 0x0($s4)
    sw      $s0, 0x18($sp)
    sw      $ra, 0x2c($sp)
    sw      $s3, 0x24($sp)
...
branch_0x801ddbf0:
    or      $a0, $s1, $zero
    or      $a1, $s2, $zero
    jal     Function_0x801ddc3c_Camera
    or      $a2, $s3, $zero
    lw      $t7, 0x0($s4)
    addiu   $s0, $s0, 0x1
    addiu   $s1, $s1, 0x10c
...
.globl Function_0x801ddc3c_Camera
Function_0x801ddc3c_Camera: # 0x801ddc3c
    lui     $t6, %hi(Unknown_0x801921b8_GeneralWaterLevel)
    lw      $t6, %lo(Unknown_0x801921b8_GeneralWaterLevel)($t6)
    addiu   $sp, $sp, 0xffc8
    lui     $v1, 0x8022
    ...
    or      $s1, $a0, $zero
    swc1    $f6, 0x0($v1)
    lwc1    $f8, CamStruct_4c($a0)
    swc1    $f8, 0x2c($sp)
    lwc1    $f10, CamStruct_50($a0)
    swc1    $f10, 0x28($sp)
    lwc1    $f16, CamStruct_54($a0)
    swc1    $f16, 0x24($sp)
    lw      $t7, CamStruct_0($a0)
    addiu   $t8, $t7, -1
    sltiu   $at, $t8, 0x8
    beqz    $at, branch_0x801de0ac
    sll     $t8, $t8, 2
    lui     $at, %hi(SwitchTable_0x80225d90)
    addu    $at, $at, $t8
    lw      $t8, %lo(SwitchTable_0x80225d90)($at)
    jr      $t8
    nop

branch_0x801ddcb0:
    lwc1    $f18, CamStruct_4($s1)
    lui     $at, 0x3f80
    mtc1    $at, $v0
    lui     $at, 0x41f0
    swc1    $f18, 0x5c($s0)
    lwc1    $f4, CamStruct_8($s1)
    mtc1    $at, $a2
    nop
    add.s   $f8, $f4, $f6
    lwc1    $f6, 0xb4($s0)
    swc1    $f8, 0x60($s0)
    lwc1    $f10, CamStruct_c($s1)
    add.s   $f8, $f6, $f2
    swc1    $f10, 0x64($s0)
    lwc1    $f16, 0x0($v1)
    swc1    $f16, 0x68($s0)
    lwc1    $f18, CamStruct_1c($s1)
    swc1    $f18, 0x80($s0)
    lwc1    $f4, CamStruct_24($s1)
    swc1    $f8, 0xb4($s0)
    b       branch_0x801de0ac
    swc1    $f4, 0x84($s0)
...
branch_0x801dddcc:
    ...
    addiu   $v1, $v1, 0x7ec8
    b       branch_0x801dde6c
    sw      $t3, CamStruct_0($s1)
branch_0x801dde10:
    lwc1    $f10, CamStruct_4($s1)
    swc1    $f10, 0x5c($s0)
    lwc1    $f18, CamStruct_fc($s1)
    lwc1    $f16, CamStruct_8($s1)
    add.s   $f4, $f16, $f18
    swc1    $f4, 0x60($s0)
    lwc1    $f6, CamStruct_c($s1)
    swc1    $f6, 0x64($s0)
    lwc1    $f8, 0x0($v1)
    swc1    $f8, 0x68($s0)
    lwc1    $f10, CamStruct_1c($s1)
    swc1    $f10, 0x80($s0)
    lwc1    $f16, CamStruct_24($s1)
    swc1    $f16, 0x84($s0)
    lwc1    $f0, CamStruct_10($s1)
    lwc1    $f2, CamStruct_18($s1)
    mul.s   $f18, $f0, $f0
    nop
    mul.s   $f4, $f2, $f2
    jal     sqrtf
...
branch_0x801dde6c:
    ...
    mul.s   $f16, $f8, $f10
    add.s   $f18, $f0, $f16
    swc1    $f18, CamStruct_fc($s1)
    lw      $t4, 0x4($a2)
    lw      $t5, 0x0($t4)
    bnel    $t5, $at, branch_0x801ddf98
    lwc1    $f18, CamStruct_8($s1)
    lw      $t6, 0x8($a2)
    lui     $a1, 0x8022
    addiu   $a1, $a1, 0x5998
    ...
    lui     $at, 0x42c8
    mtc1    $at, $zero
    lwc1    $f6, CamStruct_1c($s1)
    lwc1    $f4, CamStruct_4($s1)
    lw      $a2, 0x40($sp)
    mul.s   $f8, $f6, $f0
    lui     $v1, 0x8022
    addiu   $v1, $v1, 0x7ec8
    sub.s   $f10, $f4, $f8
    swc1    $f10, 0x74($s0)
    lwc1    $f18, CamStruct_24($s1)
    lwc1    $f16, CamStruct_c($s1)
    mul.s   $f6, $f18, $f0
    sub.s   $f4, $f16, $f6
    swc1    $f4, 0x78($s0)
branch_0x801ddef8:
    addiu   $t7, $zero, 0x1
    sw      $t7, 0x8($a2)
    lwc1    $f8, CamStruct_4($s1)
    swc1    $f8, 0x5c($s0)
    lwc1    $f18, CamStruct_fc($s1)
    lwc1    $f10, CamStruct_8($s1)
    add.s   $f16, $f10, $f18
    swc1    $f16, 0x60($s0)
    lwc1    $f6, CamStruct_c($s1)
    swc1    $f6, 0x64($s0)
    lwc1    $f4, 0x0($v1)
    swc1    $f4, 0x68($s0)
    lwc1    $f8, CamStruct_1c($s1)
    swc1    $f8, 0x80($s0)
    lwc1    $f10, CamStruct_24($s1)
    swc1    $f10, 0x84($s0)
    lwc1    $f0, CamStruct_10($s1)
    lwc1    $f2, CamStruct_18($s1)
    mul.s   $f18, $f0, $f0
...
# 0x801ddf94
    lwc1    $f18, CamStruct_8($s1)
branch_0x801ddf98:
    lwc1    $f16, CamStruct_fc($s1)
    or      $a0, $a2, $zero
    add.s   $f6, $f18, $f16
    swc1    $f6, CamStruct_8($s1)
    jal     Function_0x801dfa18
    sw      $a2, 0x40($sp)
    lwc1    $f4, CamStruct_8($s1)
    lwc1    $f8, CamStruct_fc($s1)
    lw      $a2, 0x40($sp)
    lui     $at, 0x3f80
    sub.s   $f10, $f4, $f8
    mtc1    $at, $v0
    addiu   $at, $zero, 0x5
    swc1    $f10, CamStruct_8($s1)
    lw      $t8, 0x0($a2)
    lw      $t9, 0x0($t8)
...
branch_0x801de0b4:
    ...
    or      $a0, $s1, $zero
    lwc1    $f4, CamStruct_4c($s1)
    lwc1    $f8, 0x2c($sp)
    lwc1    $f18, CamStruct_50($s1)
    or      $a0, $s1, $zero
    sub.s   $f10, $f4, $f8
    lwc1    $f4, CamStruct_54($s1)
    swc1    $f10, CamStruct_58($s1)
    lwc1    $f16, 0x28($sp)
    sub.s   $f6, $f18, $f16
    swc1    $f6, CamStruct_5c($s1)
    lwc1    $f8, 0x24($sp)
    sub.s   $f10, $f4, $f8
    jal     Function_0x801e0d50
    swc1    $f10, CamStruct_60($s1)
    lui     $a0, 0x8015
    lw      $a0, 0x1618($a0)
    jal     Function_0x801e0f14
    or      $a1, $s1, $zero
...
Function_0x801de12c: # 0x801de12c
    ...
    lui     $s6, %hi(Unknown_0x801923f0_GameStruct)
    lui     $at, 0x8022
    lui     $fp, 0x8022
    mtc1    $zero, $t8
    addiu   $fp, $fp, 0x3730
    lwc1    $f22, 0x5dd8($at)
    addiu   $s6, $s6, %lo(Unknown_0x801923f0_GameStruct)
...
Function_0x801e0ff0: # 0x801e0ff0
    ...
    nop
branch_0x801e1040:
    lui     $a2, %hi(Unknown_0x80225f88)
    addiu   $a2, $a2, %lo(Unknown_0x80225f88)
    lw      $v0, 0x0($a2)
    sltiu   $at, $v0, 0xa
    beqz    $at, branch_0x801e1554
    sll     $t8, $v0, 2

    lui     $at, %hi(SwitchTable_0x80226048)
    addu    $at, $at, $t8
    lw      $t8, %lo(SwitchTable_0x80226048)($at)
    jr      $t8
    nop
...
branch_0x801e16b0:
    ...
    addiu   $a1, $a1, 0x1380
    lui     $t4, %hi(Unknown_0x801ce39c)
    lw      $t4, %lo(Unknown_0x801ce39c)($t4)
    lw      $t5, 0x248($sp)
...
branch_0x801e1c24:
    ...
    or      $a0, $v0, $zero
    lui     $t9, %hi(MainState_0x800da8a4)
    lw      $t9, %lo(MainState_0x800da8a4)($t9)
    addiu   $at, $zero, 0x64
    sw      $v0, 0x38($sp)
...
Function_0x801e2fb0: # 0x801e2fb0
    ...
    addiu   $t7, $zero, 0x140
    sw      $t7, -0x7948($at)
    lui     $at, %hi(Unknown_0x802286bc)
    addiu   $t8, $zero, 0xfef8
    sw      $t8, %lo(Unknown_0x802286bc)($at)
branch_0x801e3010:
    lui     $at, 0x4180
    mtc1    $at, $a0
    lui     $s5, 0x801d
...
branch_0x801e3120:
    ...
    lui     $s0, 0x8023
    lui     $s0, %hi(Unknown_0x802286bc)
    b       branch_0x801e313c
    lw      $s0, %lo(Unknown_0x802286bc)($s0)
branch_0x801e3138:
    lw      $s0, -0x7948($s0)
branch_0x801e313c:
    lw      $t0, 0x0($s5)
    ...
    lw      $t7, 0xc($s7)
    sw      $t7, 0x128c($t6)
    lw      $t9, %lo(Unknown_0x802286bc)($t9)
    lw      $t4, 0x0($s5)
    addiu   $t1, $t9, 0x38
    sll     $t0, $t1, 2
    addu    $t3, $t4, $s2
...
branch_0x801e33d8:
    ...
    lui     $at, %hi(Unknown_0x802286bc)
    subu    $t6, $t5, $t4
    sw      $t6, %lo(Unknown_0x802286bc)($at)
    jr      $ra
    addiu   $sp, $sp, 0x20
...
Function_0x801e33f8: # 0x801e33f8
    ...
    jal     Function_0x800940d8
    addiu   $a2, $a2, 0x8
    lui     $a2, %hi(Unknown_0x802286bc)
    lw      $a2, %lo(Unknown_0x802286bc)($a2)
    addiu   $t9, $zero, 0x108
    addiu   $t0, $zero, 0x10
    sw      $t0, 0x14($sp)
    sw      $t9, 0x10($sp)
...
branch_0x801e35a8:
    ...
    addiu   $s3, $v0, 0x8
    lui     $v0, %hi(Unknown_0x802286bc)
    lw      $v0, %lo(Unknown_0x802286bc)($v0)
    addiu   $t2, $zero, 0xd0
    sw      $t2, 0x10($sp)
    or      $a0, $s3, $zero
    addiu   $a2, $zero, 0xc4
...
branch_0x801e360c:
    ...
    or      $s0, $zero, $zero
branch_0x801e36ac:
    lui     $t1, %hi(TrackNr_0x800d7ef0)
    lw      $t1, %lo(TrackNr_0x800d7ef0)($t1)
    or      $v0, $s3, $zero
    sw      $s1, 0x0($v0)
    sw      $s4, 0x4($v0)
    addiu   $v1, $s3, 0x8
...
branch_0x801e379c:
    ...
    lui     $t7, %hi(Unknown_0x80226110)
    lui     $t8, 0x8023
    sll     $t6, $v1, 2
    addu    $t7, $t7, $t6
    lw      $t7, %lo(Unknown_0x80226110)($t7)
    lw      $t8, -0x7948($t8)
    lui     $a2, 0x800e
    addu    $a2, $a2, $t6
    addiu   $t9, $zero, 0x21
    ...
    lui     $a3, %hi(Unknown_0x802286bc)
    lw      $a3, %lo(Unknown_0x802286bc)($a3)
    addiu   $t0, $zero, 0x5b
    sw      $t0, 0x10($sp)
    or      $a0, $v0, $zero
    addiu   $a1, $zero, 0x1
    addiu   $a2, $zero, StringID_1f
    sw      $zero, 0x14($sp)
    jal     Function_0x801e3c40_DrawStrings
    addiu   $a3, $a3, 0x17
...
a3: X-Offset
*/
.globl Function_0x801e3c40_DrawStrings
Function_0x801e3c40_DrawStrings: # 0x801e3c40
    addiu   $sp, $sp, -0x48
    sltiu   $at, $a1, 0x5
    sw      $ra, 0x2c($sp)
    sw      $fp, 0x28($sp)
    ...
    sll     $t6, $a1, 2
    lui     $at, %hi(SwitchTable_0x80226940)
    addu    $at, $at, $t6
    lw      $t6, %lo(SwitchTable_0x80226940)($at)
    jr      $t6
    nop

branch_0x801e3c98: # 0x801e3c98
    lui     $t8, %hi(Unknown_0x80226180)
    addiu   $t8, $t8, %lo(Unknown_0x80226180)
    sll     $t7, $a2, 3
    addiu   $t4, $zero, 0x8
    addu    $t1, $t7, $t8
    sw      $t1, 0x34($sp)
...
branch_0x801e3cd8: # 0x801e3cd8
    lw      $a1, 0x5c($sp)
    lui     $t8, %hi(Unknown_0x80226328)
    addiu   $t8, $t8, %lo(Unknown_0x80226328)
    sll     $t7, $a2, 3
    addu    $a3, $t7, $t8
    addiu   $t4, $a1, 0xa
    or      $v0, $zero, $zero
...
branch_0x801e3d90:
    ...
    sll     $s4, $t7, 10
    sra     $t8, $s4, 7
    lui     $s5, %hi(LowerWord(G_SETTILE(3,2,0,0,7,0,2,0,0,2,0,0)))
    ori     $s5, $s5, %lo(LowerWord(G_SETTILE(3,2,0,0,7,0,2,0,0,2,0,0)))
    or      $s4, $t8, $zero
    or      $s3, $t7, $zero
    ori     $ra, $ra, 0x200
    lui     $fp, %hi(UpperWord(G_RDPPIPESYNC))
    lui     $s7, 0x700
    lui     $s6, %hi(UpperWord(G_RDPLOADSYNC))
    lui     $s2, 0xf568
    addu    $s1, $s0, $t4
branch_0x801e3de8:
    lw      $t9, 0x3c($sp)
    or      $v0, $a0, $zero
    lui     $t6, %hi(UpperWord(G_SETTIMG(3,2)))
    beqz    $t9, branch_0x801e3f38
    lui     $t8, %hi(UpperWord(G_SETTILE(3,2,0,0,7,0,2,0,0,2,0,0)))

    sw      $t6, DrawList_0($v0)
    lw      $t7, 0x0($t1) # Offset
    addiu   $a0, $a0, DrawList_8
    or      $v1, $a0, $zero
    addiu   $a0, $a0, DrawList_8
    sw      $t7, DrawList_4($v0)
    or      $a1, $a0, $zero
    ...
    sw      $s6, DrawList_0($a1)
    lui     $t9, %hi(UpperWord(G_LOADBLOCK(0,0,0,0,0)))
    sw      $t9, DrawList_0($t2)
    lw      $a2, 0x4($t1) # Some Nr
    addiu   $t3, $t4, 0xffff
    sll     $t7, $t3, 2
    multu   $a2, $t4
    andi    $t8, $t7, 0xfff
...
branch_0x801e3ea4:
    ...
    or      $a2, $a0, $zero
    sw      $t8, DrawList_0($a1)
    lui     $t6, %hi(UpperWord(G_SETTILESIZE(0,0)))
    sw      $ra, DrawList_4($a1)
    sw      $t6, DrawList_0($a2)
    lw      $t7, 0x4($t1)
...
branch_0x801e3f38:
    lw      $t8, 0x4($t1)
    lui     $at, %hi(UpperWord(G_SETTIMG(3,1)))
    or      $v0, $a0, $zero
    addiu   $t6, $t8, 0xffff
    andi    $t7, $t6, 0xfff
    or      $t9, $t7, $at
    ...
    sw      $zero, DrawList_4($a1)
    sw      $s6, DrawList_0($a1)
    lui     $t7, %hi(UpperWord(G_LOADTILE(0,0,0,0,0)))
    sw      $t7, DrawList_0($a2)
    lw      $t8, 0x4($t1)
    sll     $t9, $a3, 2
    andi    $a3, $t9, 0xfff
    ...
    or      $a1, $a0, $zero
    sw      $t8, 0x0($v1)
    lui     $t9, %hi(UpperWord(G_SETTILESIZE(0,0)))
    sw      $ra, 0x4($v1)
    sw      $t9, DrawList_0($a1)
    lw      $t6, 0x4($t1)
    addiu   $a0, $a0, DrawList_8
...
branch_0x801e42d4:
    ...
    addiu   $t5, $zero, 0x5
    lw      $t3, %lo(TrackNr_0x800d7ef0)($t3)
...
branch_0x801e4834:
    ...
    lui     $t8, 0x8022
    lui     $t5, %hi(TrackNr_0x800d7ef0)
    lw      $t5, %lo(TrackNr_0x800d7ef0)($t5)
    lui     $t7, 0x8022
    lui     $t6, 0x8022
...
Function_0x801eaf10_ChangeStateTo2: # 0x801eaf10
    ...
    lui     $at, %hi(TrackNr_0x800d7ef0)
    sw      $zero, %lo(TrackNr_0x800d7ef0)($at) # Track_0
...
branch_0x801eb07c:
    ...
    addiu   $v0, $t8, %lo(Unknown_0x801923f0_GameStruct)
    sll     $t9, $t9, 3
    addu    $a3, $t9, $v0
    lw      $v1, 0x0($t0)
    lw      $a0, 0x4($t0)
...
Function_0x801eb284_ChangeStateTo7: # 0x801eb284
    ...
    lui     $at, %hi(Unknown_0x801ce39c)
    sw      $s0, %lo(Unknown_0x801ce39c)($at)
    lui     $at, 0x801d
    sw      $zero, -0x1c60($at)
    lui     $at, 0x801d
    sw      $zero, -0x1c5c($at)
...
branch_0x801eb314:
    ...
    addiu   $t5, $t5, 0xa9a4
    sll     $t4, $t3, 3
    sw      $t2, %lo(TrackNr_0x800d7ef0)($at)
    addu    $v0, $t4, $t5
    lh      $v1, 0x6($v0)
    lh      $a1, 0x0($v0)
    lh      $a2, 0x2($v0)
...
branch_0x801eb3c0:
    ...
    addu    $a1, $a1, $t4
    lh      $a1, -0x565c($a1)
    sw      $s0, %lo(TrackNr_0x800d7ef0)($at)
    or      $a2, $zero, $zero
    or      $a3, $zero, $zero
    or      $a0, $zero, $zero
    sw      $zero, 0x10($sp)
...
branch_0x801eb4e4:
    ...
    sh      $zero, -0x5718($at)
    lui     $t4, %hi(TrackNr_0x800d7ef0)
    lw      $t4, %lo(TrackNr_0x800d7ef0)($t4)
    lui     $t6, 0x800e
    addiu   $t6, $t6, 0x9424
    sll     $t5, $t4, 2
    subu    $t5, $t5, $t4
    sll     $t5, $t5, 4
    lui     $v1, %hi(Unknown_0x801923f0_GameStruct)
    addiu   $a1, $sp, 0x40
    sll     $t7, $a0, 2
    addu    $t0, $t7, $a1
    addiu   $v1, $v1, %lo(Unknown_0x801923f0_GameStruct)
    addu    $a3, $t5, $t6
    addiu   $a2, $zero, 0xc
branch_0x801eb5ac:
    lw      $a0, 0x0($a1)
...
Function_0x801eb6ac_ChangeStateTo1e: # 0x801eb6ac
    ...
    addiu   $a3, $zero, 0x1
    lui     $at, %hi(Unknown_0x801ce39c)
    sw      $a3, %lo(Unknown_0x801ce39c)($at)
    lui     $at, 0x801d
    sw      $zero, -0x1c60($at)
    lui     $at, 0x801d
    sw      $zero, -0x1c5c($at)
...
branch_0x801eb73c:
    ...
    addiu   $t2, $t2, %lo(TrackNr_0x800d7ef0)
    addiu   $v1, $v1, 0xb090
    sw      $t0, 0x0($v1)
    sw      $t0, 0x0($t2)
...
Function_ChangeStateToA: # 0x801ebab8
    ...
    addiu   $t1, $zero, 0x1
    lui     $at, %hi(Unknown_0x801ce39c)
    sw      $t1, %lo(Unknown_0x801ce39c)($at)
    lui     $at, 0x801d
    sw      $zero, -0x1c60($at)
    lui     $at, 0x801d
    sw      $zero, -0x1c5c($at)
...
branch_0x801ebb68:
    ...
    sw      $t6, %lo(TrackNr_0x800d7ef0)($at)
    lui     $v0, 0x800e
    lui     $a1, 0x800e
    addiu   $a1, $a1, 0xa740
    addiu   $v0, $v0, 0xa748
...
branch_0x801ebbbc:
    ...
    lw      $a0, 0x0($t9)
    addiu   $ra, $zero, 0xe
    lui     $a3, %hi(Unknown_0x801923f0_GameStruct)
    mflo    $t6
    addiu   $a3, $a3, %lo(Unknown_0x801923f0_GameStruct)
...
Function_0x801ebd74_ChangeStateTo14: # 0x801ebd74
    ...
    addiu   $t8, $zero, 0x5
    sw      $t8, %lo(Unknown_0x801ce398)($at)
    addiu   $v0, $zero, 0x1 # Track_1
    lui     $at, %hi(Unknown_0x801ce39c)
    sw      $v0, %lo(Unknown_0x801ce39c)($at)
    lui     $at, 0x801d
    sw      $zero, -0x1c60($at)
    lui     $at, 0x801d
    sw      $zero, -0x1c5c($at)
    ...
    sw      $v0, -0x5758($at)
    lui     $at, %hi(TrackNr_0x800d7ef0)
    sw      $v0, %lo(TrackNr_0x800d7ef0)($at)
    lui     $at, 0x801d
    sw      $v0, -0x1c58($at)
    lui     $at, 0x801d
    addiu   $sp, $sp, 0xffe8
...
Function_0x801ebf9c_ChangeStateTo32: # 0x801ebf9c
    lui     $a0, %hi(MainState_0x800da8a4)
    addiu   $a0, $a0, %lo(MainState_0x800da8a4)
    lw      $t6, 0x0($a0)
    lui     $v1, 0x801d
    addiu   $v1, $v1, 0xe394
    lui     $at, %hi(Unknown_0x801ce390_MainState)
...
Function_0x801ec13c_ChangeStateTo3e: # 0x801ec13c
    ...
    addiu   $t2, $t2, %lo(MainState_0x800da8a4)
    lw      $t6, 0x0($t2)
    lui     $at, 0x801d
    ...
    sw      $t9, %lo(TrackNr_0x800d7ef0)($at)
    addiu   $a3, $zero, 0x2
    lui     $at, 0x801d
    sll     $t6, $t5, 2
    sw      $a3, -0x1c58($at)
...
Function_0x801ec758_ChangeStateTo64: # 0x801ec758
    ...
    addiu   $t0, $zero, 0x1
    lui     $at, %hi(Unknown_0x801ce39c)
    sw      $t0, %lo(Unknown_0x801ce39c)($at)
    lui     $at, 0x801d
    sw      $zero, -0x1c60($at)
    lui     $at, 0x801d
    sw      $zero, -0x1c5c($at)
...
Function_0x801ec928_ChangeStateTo66: # 0x801ec928
    ...
    lui     $t4, %hi(TrackNr_0x800d7ef0)
    sw      $v1, -0x1b78($at)
    addiu   $t4, $t4, %lo(TrackNr_0x800d7ef0)
...
branch_0x801eedf0:
    ...
    lui     $t0, 0x8023
    lui     $a2, %hi(Unknown_0x801c2698_RaceStruct)
    addiu   $a2, $a2, %lo(Unknown_0x801c2698_RaceStruct)
    addiu   $t0, $t0, 0x8ae8
    addiu   $t2, $t2, %lo(Unknown_0x800d465c)
    addiu   $t5, $t5, %lo(Unknown_0x800d4660)
    addiu   $a3, $zero, RaceStruct_Size
    addiu   $t4, $zero, 0x18
    addiu   $t1, $zero, 0x14
branch_0x801eee4c:
    ...
    addu    $t8, $t8, $a1
    subu    $t6, $t6, $t3
    lui     $t9, %hi(Unknown_0x801c2698_RaceStruct)
    addiu   $v1, $t9, %lo(Unknown_0x801c2698_RaceStruct)
    sll     $t6, $t6, 3
    sll     $t8, $t8, 4
    addu    $v0, $t0, $t8
    addu    $a0, $t6, $v1
...
branch_0x801eeeac:
    ...
    lui     $v1, %hi(Unknown_0x801c2698_RaceStruct)
    addiu   $v1, $v1, %lo(Unknown_0x801c2698_RaceStruct)
branch_0x801eeeb8:
...
branch_0x801ef2e8:
    ...
    sll     $t2, $t2, 4
    lui     $t9, 0x8022
    lui     $t1, %hi(Unknown_0x801923f0_GameStruct)
    lui     $t3, %hi(Unknown_0x801c2698_RaceStruct)
    subu    $t0, $t0, $v0
    subu    $t2, $t2, $v0
    subu    $t8, $t8, $t7
    sll     $t8, $t8, 2
    addiu   $t9, $t9, 0x7a40
    sll     $t0, $t0, 3
    addiu   $t1, $t1, %lo(Unknown_0x801923f0_GameStruct)
    sll     $t2, $t2, 3
    addiu   $t3, $t3, %lo(Unknown_0x801c2698_RaceStruct)
    addu    $s1, $t8, $t9
    addu    $s5, $t0, $t1
    b       branch_0x801ef3f0
    addu    $s2, $t2, $t3
branch_0x801ef374:
    ...
    sll     $t9, $t9, 4
    lui     $t8, %hi(Unknown_0x801923f0_GameStruct)
    lui     $t0, %hi(Unknown_0x801c2698_RaceStruct)
    subu    $t7, $t7, $v0
    subu    $t9, $t9, $v0
    subu    $t5, $t5, $t4
    sll     $t5, $t5, 2
    ...
    sll     $t9, $t9, 3
    addiu   $t0, $t0, %lo(Unknown_0x801c2698_RaceStruct)
    addu    $s1, $t5, $t6
    addu    $s5, $t7, $t8
    addu    $s2, $t9, $t0
branch_0x801ef3f0:
...
branch_0x801ef430:
    ...
    lui     $t3, %hi(Unknown_0x801aeb80_ObjsStruct)
    addiu   $t3, $t3, %lo(Unknown_0x801aeb80_ObjsStruct)
    sll     $t2, $v0, 6
    addu    $t2, $t2, $v0
    sll     $t2, $t2, 2
    addu    $s3, $t2, $t3
    lwc1    $f0, ObjsStruct_0($s3)
    b       branch_0x801ef574
    lwc1    $f2, ObjsStruct_8($s3)
...
branch_0x801ef464:
    ...
    addu    $s3, $t6, $t7
    lwc1    $f0, ObjsStruct_0($s3)
    lwc1    $f10, GameStruct_44($s5)
    lwc1    $f2, ObjsStruct_8($s3)
    lwc1    $f6, GameStruct_4c($s5)
    sub.s   $f16, $f10, $f0
    lwc1    $f18, ObjsStruct_70($s3)
    lwc1    $f10, ObjsStruct_74($s3)
    sub.s   $f8, $f6, $f2
    mul.s   $f4, $f16, $f18
    mtc1    $zero, $s2
    or      $v1, $s3, $zero
...
branch_0x801ef4fc:
    addu    $t9, $t9, $a1
    lui     $t0, %hi(Unknown_0x801aeb80_ObjsStruct)
    addiu   $t0, $t0, %lo(Unknown_0x801aeb80_ObjsStruct)
    sll     $t9, $t9, 2
    addu    $s3, $t9, $t0
    lwc1    $f0, 0x0($s3)
    lwc1    $f6, GameStruct_44($s5)
    lwc1    $f2, 0x8($s3)
    lwc1    $f16, GameStruct_4c($s5)
    sub.s   $f8, $f6, $f0
    lwc1    $f10, 0x70($s3)
    lwc1    $f6, 0x74($s3)
    sub.s   $f18, $f16, $f2
...
Function_0x801efd68: # 0x801efd68
    ...
    lui     $at, 0x3f80
    lui     $s6, %hi(Unknown_0x801c2698_RaceStruct)
    lui     $s4, 0x380
    lui     $s3, 0x801b
    lui     $t1, 0xfcff
    mtc1    $at, $s6
    ...
    addiu   $s3, $s3, 0xe6b0
    ori     $s4, $s4, 0x10
    addiu   $s6, $s6, %lo(Unknown_0x801c2698_RaceStruct)
    addiu   $s7, $zero, RaceStruct_Size
branch_0x801efe20:
...
branch_0x801f025c:
    ...
    addiu   $t5, $zero, 0x4
    addiu   $t4, $zero, 0x5
    addiu   $a1, $zero, RaceStruct_Size
branch_0x801f0298:
    lhu     $t7, GameStruct_b58($a3)
    addu    $t0, $t3, $v1
    andi    $t6, $t7, JOY_Z|JOY_A
    ...
    addu    $t7, $a0, $t9
    b       branch_0x801f034c
    sw      $t4, RaceStruct_PowerMeter($t7)
branch_0x801f02d4:
...
branch_0x801f02f4:
    ...
    addu    $t7, $a0, $t9
    b       branch_0x801f034c
    sw      $ra, RaceStruct_PowerMeter($t7)
...
branch_0x801f0334:
    ...
    mflo    $t9
    addu    $t7, $a0, $t9
    sw      $t1, RaceStruct_PowerMeter($t7)
branch_0x801f034c:
    slti    $at, $a2, 0x5
branch_0x801f0350:
...
branch_0x801f0cb8:
    ...
    lw      $t7, 0x465c($t7)
    lui     $t9, %hi(Unknown_0x801c2698_RaceStruct)
    addiu   $t9, $t9, %lo(Unknown_0x801c2698_RaceStruct)
    sll     $t8, $t7, 3
    subu    $t8, $t8, $t7
    sll     $t8, $t8, 4
    subu    $t8, $t8, $t7
...
branch_0x801f0cf0:
    lui     $t0, 0x800d
    lw      $t0, 0x4660($t0)
    lui     $t2, %hi(Unknown_0x801c2698_RaceStruct)
    addiu   $t2, $t2, %lo(Unknown_0x801c2698_RaceStruct)
    sll     $t1, $t0, 3
    subu    $t1, $t1, $t0
    sll     $t1, $t1, 4
    subu    $t1, $t1, $t0
...
branch_0x801f0d98:
    ...
    addiu   $t4, $zero, 0xc
    sw      $zero, 0x34($v1)
    sw      $s3, RaceStruct_PowerMeter($s2)
    lw      $a0, 0x0($a3)
branch_0x801f0db4:
...
branch_0x801f0e30:
    ...
    swc1    $f10, 0x4($v0)
branch_0x801f0e44:
    lw      $t3, RaceStruct_PowerMeter($s2)
    slti    $at, $t3, 0x5
...
branch_0x801f0e64:
    ...
    lw      $s0, 0x70($sp)
    sw      $s3, 0x18($v1)
    lw      $t7, RaceStruct_PowerMeter($s2)
    slti    $at, $t7, 0x5
...
branch_0x801f1990:
    ...
    sw      $s3, 0x0($v0)
branch_0x801f19a8:
    lw      $t9, RaceStruct_PowerMeter($s6)
    lui     $t6, 0x101
    addiu   $t6, $t6, 0x4870
    slti    $at, $t9, 0x5
...
Function_0x801f1a8c_OutOfCourse: # 0x801f1a8c
    ...
    lw      $t7, 0x465c($t7)
    addiu   $a0, $zero, 0x378
    lui     $fp, %hi(Unknown_0x801c2698_RaceStruct)
    multu   $t7, $a0
    addiu   $fp, $fp, %lo(Unknown_0x801c2698_RaceStruct)
    addiu   $t5, $zero, 0x1
    mflo    $t8
    addu    $v0, $fp, $t8
...
branch_0x801f1b48:
    ...
    or      $s3, $zero, $zero
    lui     $s5, %hi(Unknown_0x801923f0_GameStruct)
    addiu   $s5, $s5, %lo(Unknown_0x801923f0_GameStruct)
...
Function_0x801f1df0: # 0x801f1df0
    ...
    lui     $a1, %hi(Unknown_0x801923f0_GameStruct)
    addiu   $a1, $a1, %lo(Unknown_0x801923f0_GameStruct)
    addiu   $a3, $a3, %lo(Unknown_0x801c2698_RaceStruct)
    addiu   $t0, $zero, RaceStruct_Size
...
Function_0x801f2130: # 0x801f2130
    ...
    mtc1    $at, $t8
    lui     $at, 0x40a0
    lui     $s1, %hi(Unknown_0x801923f0_GameStruct)
    lui     $s0, %hi(Unknown_0x801c2698_RaceStruct)
    mtc1    $at, $s6
    mtc1    $zero, $s4
    addiu   $s0, $s0, %lo(Unknown_0x801c2698_RaceStruct)
    addiu   $s1, $s1, %lo(Unknown_0x801923f0_GameStruct)
    addiu   $s4, $zero, 0xb4
branch_0x801f21b8:
    lwc1    $f2, 0xbc0($s1)
    lwc1    $f4, 0xbbc($s1)
...
branch_0x801f40b4:
    ...
    lui     $t7, %hi(Unknown_0x801c2698_RaceStruct)
    addiu   $t7, $t7, %lo(Unknown_0x801c2698_RaceStruct)
    sll     $t6, $t9, 3
    subu    $t6, $t6, $t9
    sll     $t6, $t6, 4
    subu    $t6, $t6, $t9
...
branch_0x801f419c:
    ...
    lw      $a0, %lo(Unknown_0x80198050)($a0)
    or      $s1, $zero, $zero
    lui     $v0, %hi(Unknown_0x801c2698_RaceStruct)
    blez    $a0, branch_0x801f4218
    addiu   $t6, $t6, %lo(Unknown_0x801c2698_RaceStruct)
    addiu   $v0, $v0, %lo(Unknown_0x801c2698_RaceStruct)
branch_0x801f41f0:
...
branch_0x801f46b0:
    ...
    lw      $t8, 0x6c4($sp)
    lui     $t9, 0xb300
    lui     $t3, %hi(Unknown_0x801923f0_GameStruct)
    addiu   $t6, $t8, 0x8
    sw      $t6, 0x6c4($sp)
    sw      $zero, 0x4($t8)
    sw      $t9, 0x0($t8)
    ...
    sw      $t9, 0x4($t7)
    lw      $v1, 0x6c4($sp)
    addiu   $t3, $t3, %lo(Unknown_0x801923f0_GameStruct)
    addiu   $s0, $s0, 0x9
    addiu   $t8, $v1, 0x8
    sw      $t8, 0x6c4($sp)
    sw      $a3, 0x0($v1)
...
branch_0x801f4f6c:
    lw      $t7, 0x465c($t7)
    lui     $s1, %hi(Unknown_0x801c2698_RaceStruct)
    sll     $t8, $t7, 3
    subu    $t8, $t8, $t7
    sll     $t8, $t8, 4
    subu    $t8, $t8, $t7
    ...
    addu    $s1, $s1, $t8
    b       branch_0x801f4ff8
    lw      $s1, %lo(Unknown_0x801c2698_RaceStruct+RaceStruct_0)($s1)
branch_0x801f4f94:
...
branch_0x801f74f4:
    ...
    subu    $t7, $t7, $t9
    sll     $t7, $t7, 3
    lui     $s1, %hi(Unknown_0x801c2698_RaceStruct+RaceStruct_BuoyMisses)
    addu    $s1, $s1, $t7
    addiu   $s3, $zero, 0xcd
    lw      $s1, %lo(Unknown_0x801c2698_RaceStruct+RaceStruct_BuoyMisses)($s1)
    b       branch_0x801f759c
    addiu   $s0, $s0, 0x38
...
Function_0x801f8b88: # 0x801f8b88
    ...
    lui     $s3, %hi(Unknown_0x801c2698_RaceStruct)
    ...
    addiu   $s3, $s3, %lo(Unknown_0x801c2698_RaceStruct)
...
branch_0x801f8c10:
    ...
    subu    $t8, $t8, $a1
    lui     $t7, %hi(Unknown_0x801c2698_RaceStruct)
    addiu   $v0, $t7, %lo(Unknown_0x801c2698_RaceStruct)
    sll     $t8, $t8, 3
    sll     $t6, $t6, 4
    addu    $s0, $a3, $t6
    addu    $v1, $t8, $v0
...
branch_0x801f8ed8:
    ...
    lui     $t8, 0x8023
    addiu   $a3, $t8, 0x8b88
    lui     $a0, %hi(Unknown_0x801923f0_GameStruct)
    lui     $t4, 0x8023
    sll     $t7, $a1, 2
    lui     $s5, 0x8023
    addiu   $s5, $s5, 0x8ba8
    addu    $s6, $t7, $a3
    addiu   $t4, $t4, 0x8b98
    addiu   $a0, $a0, %lo(Unknown_0x801923f0_GameStruct)
    or      $ra, $zero, $zero
...
# 0xe2f70
.incbin "./roms/Wave Race 64 (USA).z64", 0xe2f70, 0xF43c0 - 0xe2f70 # more pointers list here

SwitchTable_0x80225d90: # 0xF43c0
.word branch_0x801de0ac, branch_0x801ddcb0, branch_0x801de0ac, branch_0x801ddd08
.word branch_0x801de0ac, branch_0x801de070, branch_0x801dde6c, branch_0x801de08c
.word branch_0x801ddd88, branch_0x801ddd94, branch_0x801ddda0, branch_0x801dddac
.word branch_0x801dddb8, branch_0x801dddc4

.incbin "./roms/Wave Race 64 (USA).z64", 0xF43f8, 0xF45b8 - 0xF43f8

Unknown_0x80225f88: # 0xF45b8
.incbin "./roms/Wave Race 64 (USA).z64", 0xF45b8, 0xF4678 - 0xF45b8

SwitchTable_0x80226048: # 0xF4678
.incbin "./roms/Wave Race 64 (USA).z64", 0xF4678, 0xF4740 - 0xF4678

Unknown_0x80226110: # 0xF4740
.incbin "./roms/Wave Race 64 (USA).z64", 0xF4740, 0xF4958 - 0xF4740

Unknown_0x80226328: # 0xF4958
.word 0x08062DF8, 0x28
.word 0x08062F90, 0x30
.word 0x08063178, 0x50

.incbin "./roms/Wave Race 64 (USA).z64", 0xF4970, 0xF4f70 - 0xF4970

SwitchTable_0x80226940: # 0xF4f70
.word branch_0x801e3c98, branch_0x801e3cd8, branch_0x801e3d00, branch_0x801e3d3c
.word branch_0x801e3cb8, 0x0, 0x0, 0x0

.incbin "./roms/Wave Race 64 (USA).z64", 0xF4f90, 0xF5214 - 0xF4f90
