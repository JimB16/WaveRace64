...
.globl Function_0x80092084
Function_0x80092084: # 0x80092084
    addiu   $sp, $sp, 0xffe8
    sw      $ra, 0x14($sp)
...
branch_0x8009213c:
    ...
    nop
    lui     $t3, %hi(Unknown_0x800da8a4_mainState)
    lw      $t3, %lo(Unknown_0x800da8a4_mainState)($t3)
    addiu   $t4, $t3, -2
...
branch_0x80092170: # 0x80092170
    jal     Function_0x80085ee8
    nop
...
.globl Function_0x8009220c
Function_0x8009220c: # 0x8009220c
    addiu   $at, $zero, 0x8
branch_0x80092210:
...
.globl Function_0x80092228
Function_0x80092228: # 0x80092228
    addiu   $at, $zero, 0x15
branch_0x8009222c:
...
.globl Function_0x800924c8
Function_0x800924c8: # 0x800924c8
    lui     $a0, %hi(Unknown_0x800d7ef0)
    jal     Function_0x8006aa6c
    lw      $a0, %lo(Unknown_0x800d7ef0)($a0)
...
branch_0x80092514:
    ...
    nop
branch_0x80092560:
    lui     $t0, %hi(Unknown_0x800da8a4_mainState)
    lw      $t0, %lo(Unknown_0x800da8a4_mainState)($t0)
    addiu   $at, $zero, 0x28
...
branch_0x80092b5c: # 0x80092b5c
    sh      $zero, 0x0($v1)
    jal     Function_0_0x802c5ba4
    or      $a0, $s0, $zero
    b       branch_0x80092da4
    or      $s0, $v0, $zero

branch_0x80092b70: # 0x80092b70
    sh      $zero, 0x0($v1)
    jal     0x802c5800
    or      $a0, $s0, $zero
    b       branch_0x80092da4
...
.globl Function_0x80092e18
Function_0x80092e18: # 0x80092e18
    sh      $zero, 0x0($v1)
branch_0x80092e1c:
...
.globl Function_0x80092e2c
Function_0x80092e2c: # 0x80092e2c
    sh      $zero, 0x0($v1)
branch_0x80092e30:
    lui     $at, 0x800e
...
.globl Function_0x800931fc
Function_0x800931fc: # 0x800931fc
    ...
    or      $a0, $zero, $zero
    lui     $a1, %hi(Unknown_0x800d7ef0)
    jal     Function_0x8009467c
    lw      $a1, %lo(Unknown_0x800d7ef0)($a1)
    lui     $a0, 0x801d
    addiu   $a0, $a0, 0xb068
    lui     $v1, 0x801d
    lw      $t8, 0x4($a0)
    ...
    sw      $v0, 0x8($v1)
    lui     $a3, 0x801d
    lui     $ra, %hi(Unknown_0x800d7ef0)
    sw      $t8, 0xc($v1)
    sw      $t9, 0x10($v1)
    sh      $t6, 0x0($t0)
    addiu   $a3, $a3, 0xb098
    addiu   $a2, $zero, 0x1
    lw      $ra, %lo(Unknown_0x800d7ef0)($ra)
    b       branch_0x800933e4
    addiu   $t4, $zero, 0x3
branch_0x800932d8:
...
.globl Function_0x800935ec
Function_0x800935ec: # 0x800935ec
    lw      $t8, 0xb68($v0)
branch_0x800935f0:
    multu   $t8, $a2
    mflo    $t6
...
branch_0x80097ca8:
    ...
    lui     $a1, %hi(0x801516b4)
    addiu   $a1, $a1, %lo(0x801516b4)
...
.globl Function_0x80097d14
Function_0x80097d14: # 0x80097d14
...
Function_0x80097f30_CopyCodeToRam: # 0x80097f30
    ...
    lui     $t7, %hi(ROM_0xf5e50) # cart adr end
    addiu   $a0, $a0, %lo(ROM_0xa9330)
    addiu   $t7, $t7, %lo(ROM_0xf5e50)
