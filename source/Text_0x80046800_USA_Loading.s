...
branch_0x80096854:
    lw      $s0, 0x68($sp)
    lui     $a1, %hi(Unknown_0x800db0b0_FilesListToLoad)
    addiu   $a1, $a1, %lo(Unknown_0x800db0b0_FilesListToLoad)
...
branch_0x80096a0c: # 0x80096a0c
    ...
    addiu   $a1, $zero, 0x44
    lui     $a0, %hi(Unknown_0x800daa50_DriversDLOffsets)
    multu   $v0, $t3
    addiu   $a0, $a0, %lo(Unknown_0x800daa50_DriversDLOffsets)
