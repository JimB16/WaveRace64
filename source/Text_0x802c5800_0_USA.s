...
.globl Function_0x802c58cc
Function_0x802c58cc: # 0x802c58cc
    mfc1    $t9, $t0
branch_0x802c58d0:
    nop
...
.globl Function_0x802c5a4c
Function_0x802c5a4c: # 0x802c5a4c
    lw      $v0, -0x4($v1)
branch_0x802c5a50:
...
.globl Function_0x802c5a84
Function_0x802c5a84: # 0x802c5a84
    lw      $v0, 0x0($v1)
branch_0x802c5a88:
...
.globl Function_0x802c5b28
Function_0x802c5b28: # 0x802c5b28
    lw      $v0, 0x4($v1)
branch_0x802c5b2c:
...
.globl Function_0x802c5b60
Function_0x802c5b60: # 0x802c5b60
    lw      $v0, 0x0($v1)
branch_0x802c5b64:
...
.globl Function_0x802c5ba4
Function_0x802c5ba4: # 0x802c5ba4
    lui     $v0, 0x801d
    addiu   $v0, $v0, 0xe39c
    lw      $t6, 0x0($v0)
    addiu   $sp, $sp, 0xffd8
    ...
    sw      $ra, 0x24($sp)
    sw      $zero, 0x0($v0)
    lui     $t7, %hi(Unknown_0x800da8a4)
    lw      $t7, %lo(Unknown_0x800da8a4)($t7)
    addiu   $at, $zero, 0x5
...
.incbin "./roms/Wave Race 64 (USA).z64", 0x1b3bc8, ROM_0x1b3c80 - 0x1b3bc8
