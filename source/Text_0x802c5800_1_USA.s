...
.globl Function_0x802c5a7c
Function_0x802c5a7c: # 0x802c5a7c
    lui     $a1, 0x801d
    addiu   $a1, $a1, 0xe39c
    lw      $t6, 0x0($a1)
    addiu   $sp, $sp, 0xffb0
...
.globl Function_0x802c64e0
Function_0x802c64e0: # 0x802c64e0
    lw      $a1, 0x0($v1)
    sw      $zero, 0x8($v0)
    sw      $zero, 0x14($v0)
...
.globl Function_0x802c65f0
Function_0x802c65f0: # 0x802c65f0
    addiu   $a2, $zero, 0xa
    sw      $zero, 0x8($v0)
    b       branch_0x802c6644
    sw      $zero, 0x14($v0)

.globl Function_0x802c6600
Function_0x802c6600: # 0x802c6600
    addiu   $a2, $zero, 0xa
    sw      $zero, 0x8($v0)
    sw      $t0, 0xc($v0)
    sw      $t0, 0x10($v0)
...
.globl Function_0x802c6618
Function_0x802c6618: # 0x802c6618
    lui     $v1, 0x801d
    addiu   $v1, $v1, 0xb150
    sw      $zero, 0x4($v1)
    sw      $zero, 0x0($v1)
...
.globl Function_0x802c6638
Function_0x802c6638: # 0x802c6638
    b       branch_0x802c6644
    addiu   $a2, $zero, 0x3c
branch_0x802c6640:
    addiu   $a2, $zero, 0x2
...
.globl Function_0x802c6944
Function_0x802c6944: # 0x802c6944
    lui     $v0, 0x801d
    addiu   $v0, $v0, 0xe39c
    lw      $t6, 0x0($v0)
    addiu   $sp, $sp, 0xffe8
...
branch_0x802c6964:
    ...
    lw      $v0, -0x1c70($v0)
    addiu   $at, $zero, 0x2
    beq     $v0, $at, branch_0x802c69f0
    addiu   $at, $zero, 0x7
    beq     $v0, $at, branch_0x802c6a00
    addiu   $at, $zero, 0xa
    beq     $v0, $at, branch_0x802c69d0
    addiu   $at, $zero, 0x3c
    beq     $v0, $at, branch_0x802c69e0
    nop
    b       branch_0x802c6a0c
    lw      $ra, 0x14($sp)
branch_0x802c69d0:
...
.globl Function_0x802c6a1c
Function_0x802c6a1c: # 0x802c6a1c
    lui     $v0, 0x800e
    addiu   $v0, $v0, 0xa8a4
    lw      $t6, 0x0($v0)
    lui     $at, 0x801d
