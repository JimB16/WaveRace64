...
branch_0x802c59f4:
    ...
    addiu   $v1, $v1, 0x6bc8
    lw      $v0, 0x0($v1)
    lui     $t9, %hi(Unknown_0x801ce3ba_Input)
    lui     $t1, 0x800e
    slti    $at, $v0, 0x14
    ...
    sw      $t8, -0x1c58($at)
branch_0x802c5a2c:
    lhu     $t9, %lo(Unknown_0x801ce3ba_Input)($t9)
    lui     $at, 0x800e
...
Function_1_0x802c5a7c: # 0x802c5a7c
    lui     $a1, %hi(Unknown_0x801ce39c)
    addiu   $a1, $a1, %lo(Unknown_0x801ce39c)
    lw      $t6, 0x0($a1)
    addiu   $sp, $sp, 0xffb0
    sw      $s0, 0x40($sp)
    or      $s0, $a0, $zero
...
branch_0x802c5f7c:
    ...
    lui     $t2, %hi(Unknown_0x801ce3ba_Input)
    addiu   $at, $zero, 0x1
...
branch_0x802c5f98:
    ...
    sw      $t1, 0x0($v1)
branch_0x802c5fb4:
    lhu     $t2, %lo(Unknown_0x801ce3ba_Input)($t2)
...
branch_0x802c6594:
    ...
    addiu   $v0, $v0, 0xb0b0
    addiu   $v1, $v1, 0xb130
    sw      $t7, %lo(Unknown_0x801cb090)($at)
branch_0x802c65c8:
    addiu   $v0, $v0, 0x10
    addiu   $v1, $v1, 0x4
    sw      $zero, -0x10($v0)
...
branch_0x802c67fc:
    lw      $t9, 0x1c($sp)
branch_0x802c6800:
    lui     $t8, %hi(Unknown_0x801ce3ba_Input)
    beqz    $t9, branch_0x802c6860
    nop
    lhu     $t8, %lo(Unknown_0x801ce3ba_Input)($t8)
    lui     $v0, %hi(Unknown_1_0x802c6f14)
    addiu   $v0, $v0, %lo(Unknown_1_0x802c6f14)
...
Function_0x802c6878: # 0x802c6878
    ...
    addiu   $t7, $zero, 0x1
    sw      $t7, %lo(Unknown_0x801ce39c)($at)
    lui     $at, 0x801d
    sw      $zero, -0x1c60($at)
    lui     $at, 0x801d
    sw      $zero, -0x1c5c($at)
